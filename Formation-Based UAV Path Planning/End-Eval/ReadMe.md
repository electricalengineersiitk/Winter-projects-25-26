...
### Observation
* The **minimum-time trajectory** reaches the goal faster but has higher acceleration.
* The **minimum-energy trajectory** is smoother and more efficient but takes more time.
