...
HD_PWD='D:/projects/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log two_layer_network.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source two_layer_network.tcl -notrace
