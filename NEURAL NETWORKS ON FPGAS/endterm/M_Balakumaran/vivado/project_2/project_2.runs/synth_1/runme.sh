...
HD_PWD='D:/projects/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log two_layer_network.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source two_layer_network.tcl
