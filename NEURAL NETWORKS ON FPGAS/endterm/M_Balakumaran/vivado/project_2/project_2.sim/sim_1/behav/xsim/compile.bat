...
REM
REM Generated by Vivado on Tue Apr 14 21:56:52 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj top_nn_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj top_nn_tb_vlog.prj -log xvlog.log
