...
This is my final project for the course: a 2-layer neural network implemented in Verilog that classifies Iris flower inputs into three classes. I trained the weights in Python, quantized everything to Q8 fixed-point, and then deployed the design to the Basys 3 board.
